  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto pb-4 bg-zinc-950">
      ...
      <div className="flex flex-col gap-5 pt-2">
        ...
        {/* 5. NEW AI ANALYSIS CARD */}
        <div className="px-4">
          <div className="bg-zinc-900 rounded-2xl p-4 border border-zinc-800 flex items-start gap-3 shadow-lg">
            ...
            <div>
              <h3 className="text-sm font-bold text-white mb-1">Analisis AI</h3>
              <p className="text-xs text-zinc-400 leading-relaxed">
                Komposisi makananmu sudah memiliki sumber energi yang baik, namun penambahan sumber vitamin (Sayur) akan membuatnya jauh lebih seimbang.
              </p>
            </div>
          </div>
        </div>

        {/* 6. SMART AI FEEDBACK PANEL */}
